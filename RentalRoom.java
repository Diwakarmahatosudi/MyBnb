/**
   A class to represent the basic components of a rental room, including ID, number of beds, and availability.
...
public class RentalRoom
{
   ...
   /**
      Constructor to initialize the property ID and number of beds for a rental room.
